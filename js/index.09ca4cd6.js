...
function changeActiveState() {
  _variables__WEBPACK_IMPORTED_MODULE_0__.menuBtnStyle.forEach((btn) => {
    if (btn.dataset.name === _variables__WEBPACK_IMPORTED_MODULE_0__.shortPageName) {
      ...
      btn.dataset.name !== _variables__WEBPACK_IMPORTED_MODULE_0__.shortPageName &&
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   addAriaCurrent: () => (/* binding */ addAriaCurrent),
/* harmony export */   ctrlMenuVisibility: () => (/* binding */ ctrlMenuVisibility)
/* harmony export */ });
/* harmony import */ var _variables__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./variables */ "./src/variables.js");
...
function ctrlMenuVisibility() {
  _variables__WEBPACK_IMPORTED_MODULE_0__.menuIconDiv.addEventListener("pointerdown", (e) => {
    if (
      (e.target === _variables__WEBPACK_IMPORTED_MODULE_0__.menuIconDiv || e.target === _variables__WEBPACK_IMPORTED_MODULE_0__.menuIcon) &&
      !_variables__WEBPACK_IMPORTED_MODULE_0__.menuBar.classList.contains("active")
    ) {
...
function gallerySetup() {
  _variables__WEBPACK_IMPORTED_MODULE_0__.galleryMainDivs.forEach((div) => {
    if (div.dataset.name === _variables__WEBPACK_IMPORTED_MODULE_0__.shortPageName) {
      ...
      _variables__WEBPACK_IMPORTED_MODULE_0__.getPortraitSliderBox.portraitSliderLocale = document.querySelector(
        ".portrait-slider-box"
      );
      ...
      _variables__WEBPACK_IMPORTED_MODULE_0__.getLandscapeSliderBox.landscapeSliderLocale = document.querySelector(
...
/* harmony export */   getLandscapeSliderBox: () => (/* binding */ getLandscapeSliderBox),
...
/* harmony export */   getPortraitSliderBox: () => (/* binding */ getPortraitSliderBox),
...
/* harmony export */   menuIconDiv: () => (/* binding */ menuIconDiv),
/* harmony export */   menuIconWidth: () => (/* binding */ menuIconWidth),
/* harmony export */   menuLinks: () => (/* binding */ menuLinks),
/* harmony export */   message: () => (/* binding */ message),
/* harmony export */   messageError: () => (/* binding */ messageError),
/* harmony export */   navigation: () => (/* binding */ navigation),
/* harmony export */   newMenuIconWidth: () => (/* binding */ newMenuIconWidth),
